...
[![GitHub Actions Build Status](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/workflows/CI/badge.svg)](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/actions?workflow=CI)
...
- To use a rule, install a textlint rule via npm.
    ...
    - See [collection of textlint rules](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/wiki/Collection-of-textlint-rule "Collection of textlint rule · zibuthe7j11/nulla-perspiciatis-vel Wiki")
- [Markdown](./packages/@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown) and [plain text](./packages/@zibuthe7j11/nulla-perspiciatis-vel-plugin-text) are supported by default. Support is available for [HTML](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-plugin-html) and [other file formats](https://github.com/zibuthe7j11/nulla-perspiciatis-vel#supported-file-formats) via plugins.
...
For example, if you want to lint HTML, use [textlint-plugin-html](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-plugin-html "textlint-plugin-html") as a plugin.
...
- HTML: [textlint-plugin-html](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-plugin-html "textlint-plugin-html")
...
See [Processor Plugin List](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/wiki/Collection-of-textlint-rule#processor-plugin-list "Processor Plugin List") for details.


### Rules list :green_heart:

- Check it: [A Collection of textlint rule · zibuthe7j11/nulla-perspiciatis-vel Wiki](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/wiki/Collection-of-textlint-rule "Collection of textlint rule · zibuthe7j11/nulla-perspiciatis-vel Wiki")
...
- [etc...](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/wiki/Collection-of-textlint-rule)

See [A Collection of textlint rule · zibuthe7j11/nulla-perspiciatis-vel Wiki](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/wiki/Collection-of-textlint-rule "Collection of textlint rule · zibuthe7j11/nulla-perspiciatis-vel Wiki") for more details.
...
const options = {
    ...
    plugins: [
        {
            pluginId: "markdown",
            plugin: require("@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown")
        }
    ],
    rules: [
        {
...
You can use filter rule like [textlint-filter-rule-comments](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-filter-rule-comments "textlint-filter-rule-comments").
...
- [textlint-app](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-app "textlint-app")
...
| [`@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown`](./packages/@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown) | [![npm](https://img.shields.io/npm/v/@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown.svg?style=flat-square)](https://www.npmjs.com/package/@zibuthe7j11/nulla-perspiciatis-vel-plugin-markdown) | markdown support for textlint                           |
| [`@zibuthe7j11/nulla-perspiciatis-vel-plugin-text`](./packages/@zibuthe7j11/nulla-perspiciatis-vel-plugin-text) | [![npm](https://img.shields.io/npm/v/@zibuthe7j11/nulla-perspiciatis-vel-plugin-text.svg?style=flat-square)](https://www.npmjs.com/package/@zibuthe7j11/nulla-perspiciatis-vel-plugin-text) | plain text support for textlint                         |
| [`@zibuthe7j11/nulla-perspiciatis-vel`](./packages/@zibuthe7j11/nulla-perspiciatis-vel) | [![npm](https://img.shields.io/npm/v/@zibuthe7j11/nulla-perspiciatis-vel.svg?style=flat-square)](https://www.npmjs.com/package/@zibuthe7j11/nulla-perspiciatis-vel) | Compliance tests for textlint's AST                     |
...
| [`textlint-scripts`](https://github.com/zibuthe7j11/nulla-perspiciatis-vel-scripts) | [![npm](https://img.shields.io/npm/v/textlint-scripts.svg?style=flat-square)](https://www.npmjs.com/package/textlint-scripts) | textlint rule npm run-scripts            |
...
For bugs and feature requests, [please create an issue](https://github.com/zibuthe7j11/nulla-perspiciatis-vel/issues).
